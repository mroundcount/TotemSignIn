...
extension OpenerViewController {
    ...
    func setUpEmailBtn() {
        ...
        signInEmailBtn.titleLabel?.font = UIFont.systemFont(ofSize: 18)
        signInEmailBtn.backgroundColor = UIColor(red: 223/255, green: 74/255, blue: 50/255, alpha: 1)
